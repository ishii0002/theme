...
// get_header();
// ---------- ログイン処理のファイルを読み込み ---------- 
include(get_theme_file_path() . "/include-chikuhoukai-login-process.php");
?>

<link href="<?php echo get_template_directory_uri() ?>/asset/css/style-login.css" rel="stylesheet">

<div id="login">

<h1 id="login__logo"><img src="/wp-content/themes/ill/img/common/logo.svg" alt="ロゴ"></h1>

		<h1 class="login__title">ログイン画面1</h1>
