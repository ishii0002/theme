        ...
        if (!empty($_GET['user_search'])) {
            ...
            if (!empty($users)) {
                ...
                foreach ($users as $user) {
                    ...
                    echo '<li class="list">';
                    echo '<div class="list__flex">';
                    echo '<p class="list__flexLeft">ID：</p>';
                    echo '<p class="list__flexRight">' . $user->ID . '</p>';
                    echo '</div>';
                    echo '<div class="list__flex">';
                    echo '<p class="list__flexLeft">ユーザー名：</p>';
                    echo '<p class="list__flexRight">' . $user->user_login . '</p>';
                    echo '</div>';
                    echo '<div class="list__flex">';
                    echo '<p class="list__flexLeft">メールアドレス：</p>';
                    echo '<p class="list__flexRight">' . $user->user_email . '</p>';
                    echo '</div>';
                    echo '<div class="list__flex">';
                    echo '<p class="list__flexLeft">住所：</p>';
                    echo '<p class="list__flexRight">' . $address . '</p>';
                    echo '</div>';
                    echo '<div class="list__flex">';
                    echo '<p class="list__flexLeft">年齢：</p>';
                    echo '<p class="list__flexRight">' . $age . '</p>';
                    echo '</div>';
                    echo '<div class="list__flex">';
                    echo '<p class="list__flexLeft">大学：</p>';
                    echo '<p class="list__flexRight">' . $university . '</p>';
                    echo '</div>';
                    echo '<div class="list__flex">';
                    echo '<p class="list__flexLeft">学部：</p>';
                    echo '<p class="list__flexRight">' . $faculty . '</p>';
                    echo '</div>';
                    echo '</li>';
                }
                echo '</ul>';
