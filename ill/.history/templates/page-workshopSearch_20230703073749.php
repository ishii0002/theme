            ...
            $query = new WP_Query($args);
                ...
                if ($query->have_posts()) {
                    while ($query->have_posts()) {
                        ...
                        // echo '<p>' .'コンテンツ：' .get_the_content() . '</p>';
                        // echo '<p>' . '場所:'. $place . '</p>';
                        // echo '<p>' . '定員: '. $salesperson . '</p>';
                        // echo '<p>' . '講師名：'. $workshop_lecturer . '</p>';
                        // echo '</li>';

                        echo '<li class="list"><p>ID: ' . $post_id . '</p>
                        <p>タイトル：' . get_the_title() . '</p>
                        <p>コンテンツ：' . get_the_content() . '</p>
                        <p>場所：' . $place . '</p>
